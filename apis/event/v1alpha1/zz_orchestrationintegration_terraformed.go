...
func (mg *OrchestrationIntegration) GetTerraformResourceType() string {
	return "pagerduty_event_orchestration_integration"
}
...
// LateInitialize this OrchestrationIntegration using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *OrchestrationIntegration) LateInitialize(attrs []byte) (bool, error) {
	params := &OrchestrationIntegrationParameters{}
