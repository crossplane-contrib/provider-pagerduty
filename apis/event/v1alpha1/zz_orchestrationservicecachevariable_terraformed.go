...
func (mg *OrchestrationServiceCacheVariable) GetTerraformResourceType() string {
	return "pagerduty_event_orchestration_service_cache_variable"
}
...
func (tr *OrchestrationServiceCacheVariable) GetID() string {
...
// LateInitialize this OrchestrationServiceCacheVariable using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *OrchestrationServiceCacheVariable) LateInitialize(attrs []byte) (bool, error) {
	params := &OrchestrationServiceCacheVariableParameters{}
