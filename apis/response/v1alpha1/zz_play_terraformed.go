...
func (mg *Play) GetTerraformResourceType() string {
	return "pagerduty_response_play"
}
...
// GetInitParameters of this Play
func (tr *Play) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this Play using its observed tfState.
