...
func (mg *ServiceSubscriber) GetTerraformResourceType() string {
	return "pagerduty_business_service_subscriber"
}
...
func (tr *ServiceSubscriber) GetObservation() (map[string]interface{}, error) {
...
func (tr *ServiceSubscriber) SetObservation(obs map[string]interface{}) error {
...
func (tr *ServiceSubscriber) GetParameters() (map[string]interface{}, error) {
...
func (tr *ServiceSubscriber) SetParameters(params map[string]interface{}) error {
...
// LateInitialize this ServiceSubscriber using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ServiceSubscriber) LateInitialize(attrs []byte) (bool, error) {
	params := &ServiceSubscriberParameters{}
