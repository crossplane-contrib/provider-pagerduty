...
func (mg *Window) GetTerraformResourceType() string {
	return "pagerduty_maintenance_window"
}
...
func (tr *Window) GetObservation() (map[string]interface{}, error) {
...
func (tr *Window) SetObservation(obs map[string]interface{}) error {
...
func (tr *Window) GetParameters() (map[string]interface{}, error) {
...
func (tr *Window) SetParameters(params map[string]interface{}) error {
