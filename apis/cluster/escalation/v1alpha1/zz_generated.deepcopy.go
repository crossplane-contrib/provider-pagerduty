...
func (in *EscalationRuleAssignmentStrategyInitParameters) DeepCopyInto(out *EscalationRuleAssignmentStrategyInitParameters) {
	*out = *in
	if in.Type != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EscalationRuleAssignmentStrategyInitParameters.
func (in *EscalationRuleAssignmentStrategyInitParameters) DeepCopy() *EscalationRuleAssignmentStrategyInitParameters {
	if in == nil {
		return nil
	}
	out := new(EscalationRuleAssignmentStrategyInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EscalationRuleAssignmentStrategyObservation) DeepCopyInto(out *EscalationRuleAssignmentStrategyObservation) {
	*out = *in
	if in.Type != nil {
		in, out := &in.Type, &out.Type
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EscalationRuleAssignmentStrategyObservation.
func (in *EscalationRuleAssignmentStrategyObservation) DeepCopy() *EscalationRuleAssignmentStrategyObservation {
	if in == nil {
		return nil
	}
	out := new(EscalationRuleAssignmentStrategyObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EscalationRuleAssignmentStrategyParameters) DeepCopyInto(out *EscalationRuleAssignmentStrategyParameters) {
	*out = *in
	if in.Type != nil {
		in, out := &in.Type, &out.Type
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EscalationRuleAssignmentStrategyParameters.
func (in *EscalationRuleAssignmentStrategyParameters) DeepCopy() *EscalationRuleAssignmentStrategyParameters {
	if in == nil {
		return nil
	}
	out := new(EscalationRuleAssignmentStrategyParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RuleInitParameters) DeepCopyInto(out *RuleInitParameters) {
	*out = *in
	...
	if in.EscalationRuleAssignmentStrategy != nil {
		in, out := &in.EscalationRuleAssignmentStrategy, &out.EscalationRuleAssignmentStrategy
		*out = make([]EscalationRuleAssignmentStrategyInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *RuleObservation) DeepCopyInto(out *RuleObservation) {
	*out = *in
	...
	if in.EscalationRuleAssignmentStrategy != nil {
		in, out := &in.EscalationRuleAssignmentStrategy, &out.EscalationRuleAssignmentStrategy
		*out = make([]EscalationRuleAssignmentStrategyObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *RuleParameters) DeepCopyInto(out *RuleParameters) {
	*out = *in
	...
	if in.EscalationRuleAssignmentStrategy != nil {
		in, out := &in.EscalationRuleAssignmentStrategy, &out.EscalationRuleAssignmentStrategy
		*out = make([]EscalationRuleAssignmentStrategyParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
