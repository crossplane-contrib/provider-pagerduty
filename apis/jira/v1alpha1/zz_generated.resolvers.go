...
func (mg *CloudAccountMappingRule) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.Config); i3++ {
		for i4 := 0; i4 < len(mg.Spec.ForProvider.Config[i3].Jira); i4++ {
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				...
				Reference:    mg.Spec.ForProvider.Config[i3].Jira[i4].SyncNotesUserRef,
				Selector:     mg.Spec.ForProvider.Config[i3].Jira[i4].SyncNotesUserSelector,
				To: reference.To{
			...
			mg.Spec.ForProvider.Config[i3].Jira[i4].SyncNotesUserRef = rsp.ResolvedReference
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.Config); i3++ {
		rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
			...
			Extract:      reference.ExternalName(),
			Reference:    mg.Spec.ForProvider.Config[i3].ServiceRef,
		...
		mg.Spec.ForProvider.Config[i3].ServiceRef = rsp.ResolvedReference
	...
	for i3 := 0; i3 < len(mg.Spec.InitProvider.Config); i3++ {
		for i4 := 0; i4 < len(mg.Spec.InitProvider.Config[i3].Jira); i4++ {
			rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
				...
				Extract:      reference.ExternalName(),
				Reference:    mg.Spec.InitProvider.Config[i3].Jira[i4].SyncNotesUserRef,
				Selector:     mg.Spec.InitProvider.Config[i3].Jira[i4].SyncNotesUserSelector,
				To: reference.To{
					List:    &v1alpha1.UserList{},
					Managed: &v1alpha1.User{},
				},
			...
			mg.Spec.InitProvider.Config[i3].Jira[i4].SyncNotesUserRef = rsp.ResolvedReference
	...
	for i3 := 0; i3 < len(mg.Spec.InitProvider.Config); i3++ {
		rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
			...
			Extract:      reference.ExternalName(),
			Reference:    mg.Spec.InitProvider.Config[i3].ServiceRef,
		...
		mg.Spec.InitProvider.Config[i3].ServiceRef = rsp.ResolvedReference
