...
func (mg *OrchestrationGlobalCacheVariable) GetTerraformResourceType() string {
	return "pagerduty_event_orchestration_global_cache_variable"
}
...
func (tr *OrchestrationGlobalCacheVariable) GetID() string {
...
// LateInitialize this OrchestrationGlobalCacheVariable using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *OrchestrationGlobalCacheVariable) LateInitialize(attrs []byte) (bool, error) {
	params := &OrchestrationGlobalCacheVariableParameters{}
