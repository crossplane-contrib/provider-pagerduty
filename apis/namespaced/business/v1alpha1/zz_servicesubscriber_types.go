...
type ServiceSubscriberInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-pagerduty/apis/namespaced/business/v1alpha1.Service
	...
	BusinessServiceIDRef *v1.NamespacedReference `json:"businessServiceIdRef,omitempty" tf:"-"`
